#!/usr/bin/python
#title			:GlobalDistance1.py
#description		:The program uses Global Edit Distance Matching Strategy to find approximate matches for location names in tweet texts. This 				 version considers multi-word queries as lists of separate words.
#author			:Natasha A Thomas
#date			:20140905
#usage			:python GlobalDistance1.py
#notes			:
